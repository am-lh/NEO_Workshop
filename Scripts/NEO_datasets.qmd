...
#| fig-height: 5
timevision %>% 
  filter(Int_Area_Large=="Nord Bretagne") %>% 
  drop_na(Int_Area_Small) %>% 
ggplot(aes(x=station, y=sampling_date, color=bdd_base)) +
coord_flip() +
Scalc_lon(4) +
...
#| fig-height: 5
timevision %>% 
  filter(Int_Area_Large=="Atlantique") %>% 
  drop_na(Int_Area_Small) %>% 
ggplot(aes(x=station, y=sampling_date, color=bdd_base)) +
coord_flip() +
Scalc_lon(4) +
...
#| fig-height: 5
timevision %>% 
  filter(Int_Area_Large=="Mediterranee") %>% 
  drop_na(Int_Area_Small) %>% 
ggplot(aes(x=station, y=sampling_date, color=bdd_base)) +
coord_flip() +
Scalc_lon(4) +
